...
use app\modules\admin\models\ToursSearch;
...
class ToursController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'id_tour' => $model->id_tour]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($id_tour)
    {
        $model = $this->findModel($id_tour);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($id_tour)
    {
        $this->findModel($id_tour)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id_tour)
    {
        if (($model = Tours::findOne(['id_tour' => $id_tour])) !== null) {
            return $model;
        }
